	...
	<div class="span4">
		<div class="form-group">
			...
			<select name="tipo_trabajo" id="tipo_trabajo">
				...
				<option value="MTTO DE LINEAS">MTTO DE LINEAS</option>
				<option value="MANTENIMIENTO DE SSEE">MANTENIMIENTO DE SSEE</option>
				<option value="LAVADO">LAVADO</option>
				<option value="PROTECCION">PROTECCION</option>
				<option value="TELECONTROL AT/MT">TELECONTROL AT/MT</option>
				<option value="OBRA CIVIL">OBRA CIVIL</option>
				<option value="MTTO PREDICTIVO">MTTO PREDICTIVO</option>
			</select>
		</div>
    	...
    	<?php 
    		foreach ($brigadas as $value) {
    			...
    			for ($i=0; $i < count($json['brigada']); $i++) {
    				echo '<option value="'.$value->id.'" operario_id="'.$json['brigada'][$i]['id'].'">'.$value->nombre.', '.$json['brigada'][$i]['nombre'].'</option>';
    			}
    		}
    	?>
		    </select>
