...
<div class="row-fluid">
	<div class="span10">
		...
		<table class="table table-bordered">
			...
			<tr>
				<td>
					<label>No Bahia:</label>
					<input id="n_bahia" type="text" maxlength="10"/>
				</td>
				<td>
					<label>Marca:</label>
		...
		<table class="table table-bordered" style="font-size:10px;">
			...
			<tr>
				...
				<td>
					<label>
						<input name="nivel_aceite_hidraulico" type="radio" value="bueno">
						<span class="lbl"></span>
					</label>
				</td>
				<td>
					<label>
						<input name="nivel_aceite_hidraulico" type="radio" value="regular">
						<span class="lbl"></span>
					</label>
				</td>
				<td>
					<label>
						<input name="nivel_aceite_hidraulico" type="radio" value="malo">
						<span class="lbl"></span>
					</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<label>
						<input name="estado_conexion_p_t" type="radio" value="bueno">
						<span class="lbl"></span>
					</label>
				</td>
				<td>
					<label>
						<input name="estado_conexion_p_t" type="radio" value="regular">
						<span class="lbl"></span>
					</label>
				</td>
				<td>
					<label>
						<input name="estado_conexion_p_t" type="radio" value="malo">
						<span class="lbl"></span>
					</label>
				</td>
			</tr>
			<tr>
				...
				<td>
					<label>
						<input name="verf_alim_vdc" type="radio" value="bueno">
						<span class="lbl"></span>
					</label>
				</td>
				<td>
					<label>
						<input name="verf_alim_vdc" type="radio" value="regular">
						<span class="lbl"></span>
					</label>
				</td>
				<td>
					<label>
						<input name="verf_alim_vdc" type="radio" value="malo">
						<span class="lbl"></span>
					</label>
				</td>
			</tr>
...
function crearJson(){
	var json='{'+
		  ...
		  '"nivel_aceite_hidraulico": "'+$('input[name=nivel_aceite_hidraulico]:checked').val()+'",'+
		  '"estado_conexion_p_t": "'+$('input[name=estado_conexion_p_t]:checked').val()+'",'+
		  '"verf_alim_vdc": "'+$('input[name=verf_alim_vdc]:checked').val()+'",'+
...
function cargarDatos(){
	...
	if(text.length>0){
		...
		$('input[name=nivel_aceite_hidraulico][value='+data.nivel_aceite_hidraulico+']').prop('checked',true);
		$('input[name=estado_conexion_p_t][value='+data.estado_conexion_p_t+']').prop('checked',true);
		$('input[name=verf_alim_vdc][value='+data.verf_alim_vdc+']').prop('checked',true);
