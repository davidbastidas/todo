...
<div class="row-fluid">
	<div class="span10">
		...
		<table class="table table-bordered">
			...
			<tr>
				<td>
					<label>No Seccionador:</label>
					<input id="n_seccionador" type="text" maxlength="10"/>
				</td>
				<td>
					<label>Marca:</label>
			...
			<tr>
				...
				<td>
					...
					<input id="corriente" type="text" maxlength="10"/>
				</td>
				<td>
		...
		<table class="table table-bordered" style="font-size:10px;">
			...
			<tr>
				<td>Estado brazos de potencia (ajuste  - linealidad)</td>
				<td>
					<label>
						<input name="brazos_potencia" type="radio" value="bueno">
						<span class="lbl"></span>
					</label>
				</td>
				<td>
					<label>
						<input name="brazos_potencia" type="radio" value="regular">
						<span class="lbl"></span>
					</label>
				</td>
				<td>
					<label>
						<input name="brazos_potencia" type="radio" value="malo">
						<span class="lbl"></span>
					</label>
				</td>
			</tr>
			...
			<tr>
				<td>Estado alimentacion polos </td>
				<td>
					<label>
						<input name="alimentacion_polos" type="radio" value="bueno">
						<span class="lbl"></span>
					</label>
				</td>
				<td>
					<label>
						<input name="alimentacion_polos" type="radio" value="regular">
						<span class="lbl"></span>
					</label>
				</td>
				<td>
					<label>
						<input name="alimentacion_polos" type="radio" value="malo">
						<span class="lbl"></span>
					</label>
				</td>
			</tr>
			<tr>
				<td>Estado varillaje de accionamiento</td>
				<td>
					<label>
						<input name="varillaje_accionamiento" type="radio" value="bueno">
						<span class="lbl"></span>
					</label>
				</td>
				<td>
					<label>
						<input name="varillaje_accionamiento" type="radio" value="regular">
						<span class="lbl"></span>
					</label>
				</td>
				<td>
					<label>
						<input name="varillaje_accionamiento" type="radio" value="malo">
						<span class="lbl"></span>
					</label>
				</td>
			</tr>
			<tr>
				<td>Estado grapas conexión AT</td>
				<td>
					<label>
						<input name="conexion_at" type="radio" value="bueno">
						<span class="lbl"></span>
					</label>
				</td>
				<td>
					<label>
						<input name="conexion_at" type="radio" value="regular">
						<span class="lbl"></span>
					</label>
				</td>
				<td>
					<label>
						<input name="conexion_at" type="radio" value="malo">
						<span class="lbl"></span>
					</label>
				</td>
			</tr>
			<tr>
				<td>Estado de mecanismos de accionamiento electricos</td>
				<td>
					<label>
						<input name="accionamiento_electrico" type="radio" value="bueno">
						<span class="lbl"></span>
					</label>
				</td>
				<td>
					<label>
						<input name="accionamiento_electrico" type="radio" value="regular">
						<span class="lbl"></span>
					</label>
				</td>
				<td>
					<label>
						<input name="accionamiento_electrico" type="radio" value="malo">
						<span class="lbl"></span>
					</label>
				</td>
			</tr>
...
function crearJson(){
	var json='{'+
		  ...
		  '"fecha": "'+$("#fecha").val()+'",'+
		  '"hora": "'+$("#hora").val()+'",'+
		  '"n_seccionador": "'+$("#n_seccionador").val()+'",'+
		  '"marca": "'+$("#marca").val()+'",'+
		  ...
		  '"brazos_potencia": "'+$('input[name=brazos_potencia]:checked').val()+'",'+
		  '"estado_polos": "'+$('input[name=estado_polos]:checked').val()+'",'+
		  '"alimentacion_polos": "'+$('input[name=alimentacion_polos]:checked').val()+'",'+
		  '"varillaje_accionamiento": "'+$('input[name=varillaje_accionamiento]:checked').val()+'",'+
		  '"conexion_at": "'+$('input[name=conexion_at]:checked').val()+'",'+
		  '"accionamiento_electrico": "'+$('input[name=accionamiento_electrico]:checked').val()+'",'+
...
function cargarDatos(){
	...
	if(text.length>0){
		...
		$("#hora").val(data.hora)
		$("#n_seccionador").val(data.n_seccionador)
		$("#marca").val(data.marca)
		$("#n_serial").val(data.n_serial)
		$("#voltaje").val(data.voltaje)
		$("#corriente").val(data.corriente)
		...
		$('input[name=brazos_potencia][value='+data.brazos_potencia+']').prop('checked',true);
		$('input[name=estado_polos][value='+data.estado_polos+']').prop('checked',true);
		$('input[name=alimentacion_polos][value='+data.alimentacion_polos+']').prop('checked',true);
		$('input[name=varillaje_accionamiento][value='+data.varillaje_accionamiento+']').prop('checked',true);
		$('input[name=conexion_at][value='+data.conexion_at+']').prop('checked',true);
		$('input[name=accionamiento_electrico][value='+data.accionamiento_electrico+']').prop('checked',true);
