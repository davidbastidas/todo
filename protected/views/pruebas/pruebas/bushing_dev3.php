...
function aplicarReglas(){
	...
	function crearJson(){
		...
		var json=''
				  ...
				  +'],'
				   +'"tabla_y": ['
				    +'{'
				        +'"y0_c1_tap": "'+$("#y0_c1_tap").val()+'",'
				        +'"y0_c2_tap": "'+$("#y0_c2_tap").val()+'",'

				        +'"y0_c1_cap": "'+$("#y0_c1_cap").val()+'",'
				        +'"y0_c2_cap": "'+$("#y0_c2_cap").val()+'",'

				        +'"y1_c1_tap": "'+$("#y1_c1_tap").val()+'",'
				        +'"y1_c2_tap": "'+$("#y1_c2_tap").val()+'",'
 
				        +'"y1_c1_cap": "'+$("#y1_c1_cap").val()+'",'
				        +'"y1_c2_cap": "'+$("#y1_c2_cap").val()+'",'

				        +'"y2_c1_tap": "'+$("#y2_c1_tap").val()+'",'
				        +'"y2_c2_tap": "'+$("#y2_c2_tap").val()+'",'

				        +'"y2_c1_cap": "'+$("#y2_c1_cap").val()+'",'
				        +'"y2_c2_cap": "'+$("#y2_c2_cap").val()+'",'

				        +'"y3_c1_tap": "'+$("#y3_c1_tap").val()+'",'
				        +'"y3_c2_tap": "'+$("#y3_c2_tap").val()+'",'

				        +'"y3_c1_cap": "'+$("#y3_c1_cap").val()+'",'
				        +'"y3_c2_cap": "'+$("#y3_c2_cap").val()+'"'
				    +'}'
				  +'],'
	...
	function cargarDatos(){
		...
		if(text.length>0){
			...
			//************************
			$("#y0_c1_tap").val(data.tabla_y[0].y0_c1_tap)
			$("#y0_c2_tap").val(data.tabla_y[0].y0_c2_tap)

			$("#y0_c1_cap").val(data.tabla_y[0].y0_c1_cap)
			$("#y0_c2_cap").val(data.tabla_y[0].y0_c2_cap)

			$("#y1_c1_tap").val(data.tabla_y[0].y1_c1_tap)
			$("#y1_c2_tap").val(data.tabla_y[0].y1_c2_tap)
 
			$("#y1_c1_cap").val(data.tabla_y[0].y1_c1_cap)
			$("#y1_c2_cap").val(data.tabla_y[0].y1_c2_cap)

			$("#y2_c1_tap").val(data.tabla_y[0].y2_c1_tap)
			$("#y2_c2_tap").val(data.tabla_y[0].y2_c2_tap)

			$("#y2_c1_cap").val(data.tabla_y[0].y2_c1_cap)
			$("#y2_c2_cap").val(data.tabla_y[0].y2_c2_cap)

			$("#y3_c1_tap").val(data.tabla_y[0].y3_c1_tap)
			$("#y3_c2_tap").val(data.tabla_y[0].y3_c2_tap)

			$("#y3_c1_cap").val(data.tabla_y[0].y3_c1_cap)
			$("#y3_c2_cap").val(data.tabla_y[0].y3_c2_cap)
...
<div class="row-fluid">
	<div class="span12">
		<table id="table_y" class="table table-bordered">
				<tr>
					<th colspan="4" class="center">Datos de placa toma capacitiva</th>
				</tr>
			...
			<tbody>
				...
				<tr>
					<td class="center input-mini" rowspan="2">Y0</td>
					<td class="center input-mini">C1</td>
					<td class="center input-mini"><input id="y0_c1_tap" class="input-mini decimal decimalmax" type="text"></td>
					<td class="center input-mini"><input id="y0_c1_cap" class="input-mini decimal decimalmax" type="text"></td>
				</tr>
				<tr>
					<td class="center input-mini">C2</td>
					<td class="center input-mini"><input id="y0_c2_tap" class="input-mini decimal decimalmax" type="text"></td>
					<td class="center input-mini"><input id="y0_c2_cap" class="input-mini decimal decimalmax" type="text"></td>
				</tr>
				<tr>
					<td class="center input-mini"></td>
					<td class="center input-mini" colspan="2">F.P TAP CAPACITIVO</td>
				...
				<tr>
					<td class="center input-mini" rowspan="2">Y1</td>
					<td class="center input-mini">C1</td>
					<td class="center input-mini"><input id="y1_c1_tap" class="input-mini decimal decimalmax" type="text"></td>
					<td class="center input-mini"><input id="y1_c1_cap" class="input-mini decimal decimalmax" type="text"></td>
				</tr>
				<tr>
					<td class="center input-mini">C2</td>
					<td class="center input-mini"><input id="y1_c2_tap" class="input-mini decimal decimalmax" type="text"></td>
					<td class="center input-mini"><input id="y1_c2_cap" class="input-mini decimal decimalmax" type="text"></td>
				</tr>
				<tr>
					<td class="center input-mini"></td>
					<td class="center input-mini" colspan="2">F.P TAP CAPACITIVO</td>
				...
				<tr>
					<td class="center input-mini" rowspan="2">Y2</td>
					<td class="center input-mini">C1</td>
					<td class="center input-mini"><input id="y2_c1_tap" class="input-mini decimal decimalmax" type="text"></td>
					<td class="center input-mini"><input id="y2_c1_cap" class="input-mini decimal decimalmax" type="text"></td>
				</tr>
				<tr>
					<td class="center input-mini">C2</td>
					<td class="center input-mini"><input id="y2_c2_tap" class="input-mini decimal decimalmax" type="text"></td>
					<td class="center input-mini"><input id="y2_c2_cap" class="input-mini decimal decimalmax" type="text"></td>
				</tr>
				<tr>
					<td class="center input-mini"></td>
					<td class="center input-mini" colspan="2">F.P TAP CAPACITIVO</td>
				...
				<tr>
					<td class="center input-mini" rowspan="2">Y3</td>
					<td class="center input-mini">C1</td>
					<td class="center input-mini"><input id="y3_c1_tap" class="input-mini decimal decimalmax" type="text"></td>
					<td class="center input-mini"><input id="y3_c1_cap" class="input-mini decimal decimalmax" type="text"></td>
				</tr>
				<tr>
					<td class="center input-mini">C2</td>
					<td class="center input-mini"><input id="y3_c2_tap" class="input-mini decimal decimalmax" type="text"></td>
					<td class="center input-mini"><input id="y3_c2_cap" class="input-mini decimal decimalmax" type="text"></td>
				</tr>
			</tbody>
		</table>
	</div>
