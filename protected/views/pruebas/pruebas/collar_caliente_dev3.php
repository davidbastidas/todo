...
function aplicarReglas(){
	...
	function crearJson(){
		...
		var y0=$("#table_1 tr").find("#y0").val();
		var y1=$("#table_1 tr").find("#y1").val();
		var y2=$("#table_1 tr").find("#y2").val();
		var y3=$("#table_1 tr").find("#y3").val();
	...
	function cargarDatos(){
		...
		if(text.length>0){
			...
			$("#table_1 tr #y0").val(data.tabla1[0].y0);
			$("#table_1 tr #y1").val(data.tabla1[0].y1);
			$("#table_1 tr #y2").val(data.tabla1[0].y2);
			$("#table_1 tr #y3").val(data.tabla1[0].y3);
...
<table id="table_1" class="table table-bordered">
		<tr>
			...
			<th colspan="12" class="center">Bujes</th>
		</tr>
		<tr>
			...
			<td class="center input-mini">Y0</td>
			<td class="center input-mini">Y1</td>
			<td class="center input-mini">Y2</td>
			<td class="center input-mini">Y3</td>
		</tr>
	<tbody>
		<tr>
			...
			<td class="center input-mini"><input id="y0" class="input-mini decimal decimalmax" type="text"></td>
			<td class="center input-mini"><input id="y1" class="input-mini decimal decimalmax" type="text"></td>
			<td class="center input-mini"><input id="y2" class="input-mini decimal decimalmax" type="text"></td>
			<td class="center input-mini"><input id="y3" class="input-mini decimal decimalmax" type="text"></td>
		</tr>
	</tbody>
</table>
