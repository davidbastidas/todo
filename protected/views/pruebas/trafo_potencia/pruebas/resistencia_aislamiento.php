...
'<div class="breadcrumbs fixed" id="breadcrumbs">'.
	'<ul class="breadcrumb">'.
		...
		'</li>'.
		'<li>'.
			"Resistencia de Aislamiento TP's".
		'</li>'.
	'</ul>'.
'</div>';
...
var tipo_equipo="<?php if(isset($datos_equipo['clase'])){echo $datos_equipo['clase'];}else{echo '0';}?>";
//tabla 100.14
...
$( document ).ready(function() {
	...
	for (i = 0; i < size; i++) {
		...
		}else if(tipo_equipo=="Inmerso en Aceite"){
...
<div id="contenedor">
	<div class="row-fluid">
	  <div class="span6">
		<h3>Resistencia de Aislamiento TP's</h3>
	  </div>
	  <div class="span6">
