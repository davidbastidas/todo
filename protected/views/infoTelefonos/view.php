...
Yii::app()->params['breadcrumbs']='<div class="breadcrumbs fixed" id="breadcrumbs">
	<ul class="breadcrumb">
		...
		<li class="active">
			<a href="/proyecto/Info Telefonos/index">Info Telefonos</a>
			<span class="divider">
				 <i class="icon-angle-right arrow-icon"></i>
			</span>
		</li>
...
<h2>Ver InfoTelefonos #<?php echo $model->id; ?></h2>
...
<div class="profile-user-info profile-user-info-striped">
	...
	<div class="profile-info-row">
	<div class="profile-info-name"> numero: </div>
	<div class="profile-info-value">
	<span style="display: inline;"><?php echo $model->numero?></span>
	</div>
	</div>
	<div class="profile-info-row">
	...
	<div class="profile-info-row">
	<div class="profile-info-name"> imei: </div>
	<div class="profile-info-value">
	<span style="display: inline;"><?php echo $model->imei?></span>
	</div>
	</div>
	<div class="profile-info-row">
