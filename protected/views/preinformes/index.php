...
function consultar(page){
	...
	if(pasa){
		$.ajax({
            url:"<?php echo $nameProyect?>/Preinformes/ListarPruebas",
            type:'POST',
            dataType:"json",
            cache:false,
            data: {
...
function eliminar(id){
    var r = confirm("Desea Eliminar la Prueba "+id);
    if (r == true) {
            $.ajax({
            url:"<?php echo $nameProyect?>/Pruebas/EliminarPrueba",
            type:'POST',
            dataType:"json",
            cache:false,
            data: {
            ...
            beforeSend:  function() {
                $("#info2").html('<i class="icon-spinner icon-spin orange bigger-125"></i>');
            },
            success: function(data){
                if(parseInt(data.respuesta)==1){
                    var html='<div class="alert alert-success">'+
                            ...
                            'Eliminado! '+
                            '</strong>'+
                            'Se elimino '+data.respuesta+' Registro'+
                            '<br>'+
                            '</div>';
                    $("#info2").html(html);
                    consultar();
...
<h3>Ingrese las fechas para buscar la prueba</h3>
<div id="info2"></div>
<div id="info"></div>
