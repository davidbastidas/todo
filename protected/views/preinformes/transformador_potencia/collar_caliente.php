...
for ($y=0; $y < $n_filas; $y++) {?>
		<tr>
			<td <?php echo $style_centro?>><?php echo $array['tabla'][$y]['fase']?></td>
			<td <?php echo $style_centro?>><?php echo $array['tabla'][$y]['serie']?></td>
			<td <?php echo $style_centro?>><?php echo $array['tabla'][$y]['vprueba']?></td>
