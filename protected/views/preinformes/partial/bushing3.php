...
<table class="border">
	<tbody>
		...
		<tr>
			<td  rowspan="2">Y0</td>
			<td >C1</td>
			<td ><?php echo $array['tabla_y'][0]['y0_c1_tap']?></td>
			<td ><?php echo $array['tabla_y'][0]['y0_c1_cap']?></td>
		</tr>
		<tr>
			<td >C2</td>
			<td ><?php echo $array['tabla_y'][0]['y0_c2_tap']?></td>
			<td ><?php echo $array['tabla_y'][0]['y0_c2_cap']?></td>
		</tr>
		<tr>
			<td ></td>
			<td  colspan="2">F.P TAP CAPACITIVO</td>
		...
		<tr>
			<td  rowspan="2">Y1</td>
			<td >C1</td>
			<td ><?php echo $array['tabla_y'][0]['y1_c1_tap']?></td>
			<td ><?php echo $array['tabla_y'][0]['y1_c1_cap']?></td>
		</tr>
		<tr>
			<td >C2</td>
			<td ><?php echo $array['tabla_y'][0]['y1_c2_tap']?></td>
			<td ><?php echo $array['tabla_y'][0]['y1_c2_cap']?></td>
		</tr>
		<tr>
			<td ></td>
			<td  colspan="2">F.P TAP CAPACITIVO</td>
		...
		<tr>
			<td  rowspan="2">Y2</td>
			<td >C1</td>
			<td ><?php echo $array['tabla_y'][0]['y2_c1_tap']?></td>
			<td ><?php echo $array['tabla_y'][0]['y2_c1_cap']?></td>
		</tr>
		<tr>
			<td >C2</td>
			<td ><?php echo $array['tabla_y'][0]['y2_c2_tap']?></td>
			<td ><?php echo $array['tabla_y'][0]['y2_c2_cap']?></td>
		</tr>
		<tr>
			<td ></td>
			<td  colspan="2">F.P TAP CAPACITIVO</td>
		...
		<tr>
			<td  rowspan="2">Y3</td>
			<td >C1</td>
			<td ><?php echo $array['tabla_y'][0]['y3_c1_tap']?></td>
			<td ><?php echo $array['tabla_y'][0]['y3_c1_cap']?></td>
		</tr>
		<tr>
			<td >C2</td>
			<td ><?php echo $array['tabla_y'][0]['y3_c2_tap']?></td>
			<td ><?php echo $array['tabla_y'][0]['y3_c2_cap']?></td>
		</tr>
	</tbody>
</table>
