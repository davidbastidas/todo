 ...
 * @since 1.1
 */
class DButtonColumn extends DGridColumn
{
	/**
	 ...
	 */
	public $viewButtonOptions=array('class'=>'blue');
	 ...
	 */
	public $updateButtonOptions=array('class'=>'green');
	 ...
	 * @var array the HTML options for the view button tag.
	 */
	public $deleteButtonOptions=array('class'=>'red');
	/**
