...
Yii::import('application.extensions.gii.CCodeGenerator');
Yii::import('application.extensions.gii.CCodeModel');
Yii::import('application.extensions.gii.CCodeFile');
Yii::import('application.extensions.gii.CCodeForm');
